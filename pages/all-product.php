<?php include "header.php"; ?>
    ...
    <section class="py-5 product-bg-dark">
        <div class="container">
            <div class="col">
                <div class="h1 text-center px-3 py-5 text-light text-capitalize bg-dark mb-3"><?php echo 'our all product'; ?></div>
            </div>
            <div class="row">
                ...
                <?php foreach ($productShow as $product) { ?>
                    ...
                    <div class="col-md-3 py-5 product-h">
                        <div class="card h-100 py-2 product-inner-bg">
                            <img src="./assets/img/product/<?php echo $product['image']; ?>" alt="" class="card-img-top h-75 w-50 mx-auto p-3"/>
                            <div class="card-body">
                                <div class="card-text">
                                    <hr/>
                                    <h4 class="fw-bold text-uppercase"><?php echo $product['name']; ?></h4>
